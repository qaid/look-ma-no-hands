---
name: ux-review
description: Professional UI/UX audit and design analysis
model: sonnet
triggers:
  - ux review
  - ui review
  ...
  - design audit
invocation_patterns:
  - "When user requests a UX review, UI audit, or design analysis"
  - "When user asks about usability, user experience, or interface design"
  - "When user wants to check compliance with Apple Human Interface Guidelines"
  - "When user mentions Nielsen's heuristics or design best practices"
  - "When user asks how to improve the UI or make the app more polished"
---
...
This agent evaluates the app against Apple Human Interface Guidelines, macOS menu bar app conventions, and Nielsen's usability heuristics to ensure a polished, native experience.
