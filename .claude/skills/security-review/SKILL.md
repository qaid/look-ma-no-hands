...
This skill analyzes the codebase for vulnerabilities specific to macOS apps handling sensitive permissions (Accessibility, Microphone) and local audio/text processing.
